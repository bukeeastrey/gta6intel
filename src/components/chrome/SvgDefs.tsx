// ════════════════════════════════════════════════════════════
// SvgDefs — hidden <symbol> sprite, ported verbatim from v9.
// Rendered once in the root layout so every <use href="#ico-*"/>
// across nav / footer / social strips resolves correctly.
// ════════════════════════════════════════════════════════════
export function SvgDefs() {
  return (
    <svg style={{ display: 'none' }} aria-hidden="true">
      ...
      <symbol id="ico-tk" viewBox="0 0 24 24">
      ...
      <symbol id="ico-user" viewBox="0 0 24 24">
        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" fill="none" />
      </symbol>
    </svg>
  );
}
