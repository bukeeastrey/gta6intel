// Maps placeholder — generalized (not Leonida-specific, since interactive /
// regional / other maps may release over time). Neutral abstract "map
// structure" (no real geography) locked behind a COMING SOON overlay.
// Non-interactive by design. Swap in real maps only when credible.
export function MapsComingSoon() {
  return (
    <section className="map-cs-wrap" aria-labelledby="map-cs-title">
      <div className="section-header">
        <h2 className="section-title rl" id="map-cs-title">
          GTA 6 <span>Maps</span>
        </h2>
      </div>
      <div className="map-cs" role="img" aria-label="GTA 6 maps — coming soon">
        ...
        <div className="map-cs-overlay">
          ...
          <p className="map-cs-note">No official GTA 6 maps have been released yet. We&rsquo;ll add real ones here — interactive, regional and more — the moment credible sources exist. Never a fake.</p>
        </div>
      </div>
    </section>
  );
